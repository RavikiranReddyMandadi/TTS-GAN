...
from .attention import LayerNorm, Encoder, CouplingBlock
...
class TextEncoder(nn.Module):
    def __init__(self, 
        ...
        if prenet:
            self.pre = ConvReluNorm(hidden_channels, hidden_channels, hidden_channels, kernel_size=5, n_layers=3, p_dropout=0.5)
...
class FlowSpecDecoder(nn.Module):
    ...
    def forward(self, x, x_mask, g=None, reverse=False):
        ...
        for f in flows:
            if not reverse:
                # print('Decoder layers ==============', f, x.shape, x_mask.shape)
...
class FlowGenerator(nn.Module):
    ...
    def forward(self, x, x_lengths, y=None, y_lengths=None, g=None, gen=False, noise_scale=1., length_scale=1.):
        ...
        if gen:
            ...
            # print('Decoder ============ ', y.shape, z_mask.shape)
